...
export default class Container implements ContainerContract {
    ...
    protected _namespaceMap: NamespaceMap;
    constructor(rootPath?: string, autoLoadNamespaces?: Array<Namespace>);
    setRootPath(rootPath: string): this;
    setNamespaces(autoLoadNamespaces: Array<Namespace>): this;
    get(id: any): any;
    protected namespaceResolve(namespace: string): string;
    protected autoLoadResolve(namespace: string): any;
     ...
     * @return void
     */
    bind($abstract: any, concrete: Closure | string, shared?: boolean): void;
     ...
     * @param parameters
     */
    makeWith($abstract: any, parameters?: any[]): any;
    /**
     ...
     * @param parameters
     */
    make($abstract: any, parameters?: Array<any>): any;
    /**
